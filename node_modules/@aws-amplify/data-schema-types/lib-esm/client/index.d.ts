...
type ModelTypesClient<Model extends Record<string, unknown>, ModelMeta extends ModelMetaShape> = IndexQueryMethodsFromIR<ModelMeta['secondaryIndexes'], Model> & {
    ...
    list<FlatModel extends Record<string, unknown> = ResolvedModel<Model>, SelectionSet extends ReadonlyArray<ModelPath<FlatModel>> = never[]>(options?: Partial<ModelIdentifier<ModelMeta>> & {
...
type ModelTypesSSRRequest<Model extends Record<string, unknown>, ModelMeta extends ModelMetaShape> = IndexQueryMethodsFromIR<ModelMeta['secondaryIndexes'], Model> & {
    ...
    list<FlatModel extends Record<string, unknown> = ResolvedModel<Model>, SelectionSet extends ReadonlyArray<ModelPath<FlatModel>> = never[]>(contextSpec: any, options?: Partial<ModelIdentifier<ModelMeta>> & {
        filter?: ModelFilter<Model>;
        sortDirection?: ModelSortDirection;
        limit?: number;
        nextToken?: string | null;
