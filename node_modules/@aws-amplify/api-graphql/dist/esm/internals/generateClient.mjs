...
import { generateCustomQueriesProperty, generateCustomMutationsProperty, generateCustomSubscriptionsProperty } from './generateCustomOperationsProperty.mjs';
...
function generateClient(params) {
    ...
    if (isApiGraphQLConfig(apiGraphqlConfig)) {
        ...
        client.subscriptions = generateCustomSubscriptionsProperty(client, apiGraphqlConfig);
    }
    else {
...
const generateModelsPropertyOnAmplifyConfigure = (clientRef) => {
    Hub.listen('core', coreEvent => {
        ...
        if (isApiGraphQLConfig(apiGraphQLConfig)) {
            ...
            clientRef.subscriptions = generateCustomSubscriptionsProperty(clientRef, apiGraphQLConfig);
        }
    });
};
