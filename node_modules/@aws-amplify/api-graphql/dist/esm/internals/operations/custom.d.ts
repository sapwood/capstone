...
import { CustomOperation, ModelIntrospectionSchema } from '@aws-amplify/core/internals/utils';
import { AuthModeParams, ClientWithModels, ListArgs, QueryArgs } from '../../types';
 ...
 */
export declare function customOpFactory(client: ClientWithModels, modelIntrospection: ModelIntrospectionSchema, operationType: 'query' | 'mutation' | 'subscription', operation: CustomOperation, useContext: boolean): (...args: OpArgs) => Promise<any> | import("rxjs").Observable<any>;
export {};
