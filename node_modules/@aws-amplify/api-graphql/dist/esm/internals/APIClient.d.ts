import { GraphQLAuthMode, ModelIntrospectionSchema, SchemaModel, SchemaNonModel } from '@aws-amplify/core/internals/utils';
...
export declare function defaultSelectionSetForNonModelWithIR(nonModelDefinition: SchemaNonModel, modelIntrospection: ModelIntrospectionSchema): Record<string, unknown>;
/**
