...
function graphql(options, additionalHeaders) {
    ...
    options.authMode = options.authMode || this[types_1.__authMode];
    options.authToken = options.authToken || this[types_1.__authToken];
    /**
     ...
     */
    const result = GraphQLAPI_1.GraphQLAPI.graphql(this[types_1.__amplify], options, additionalHeaders);
    return result;
}
